...
public class IAPDemo : MonoBehaviour, IStoreListener
{
	...
	public void Awake()
	{
		...
		builder.Configure<IGooglePlayConfiguration>().SetPublicKey("");
	...
	private void InitUI(IEnumerable<Product> items)
	{
		...
		GetBuyButton().onClick.AddListener(() => { 
			...
			//Analytics.CustomEvent("test_custom_event", new Dictionary<string, object>{{"1", 1},{"2", true}});
